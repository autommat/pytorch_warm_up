...
if __name__ == '__main__':
    ...
    # model_ft, acc, cm = test(own_net_model, device, test_loader, own_criterion, own_net_optimizer)

    cm_file = open('../res_longest/cm.txt', 'w+')
    ...
    acc_file = open('../res_longest/acc.txt', 'w+')
    ...
    acc_filetr = open('../res_longest/acctr.txt', 'w+')
